...
from V1.modelos import Lineal
from V1.logica.constantes import TERRENOS
from V1.logica.estado import get_sim, SimState
from V1.logica.trayectoria import get_origen_latlon, parse_trayectoria, calcular_errores
from V1.ui.figura import build_figure
